...
[NodeDescription(
    name: "Dragon Wing Slam Bite Combo",
    story: "[Self] uses random wing slams then bite",
    category: "Action/Dragon",
    id: "dragon_wing_slam_bite_combo_action")]
public partial class DragonWingSlamBiteComboAction : Action
{
    ...
    protected override Status OnUpdate()
    {
        ...
        // 6. 전체 종료
        if (timer >= boss.wingSlamBiteComboDuration)
        {
            boss.DisableAllWingHitboxes();
            boss.DisableBiteHitbox();

            boss.StartWingSlamBiteComboCooldown();
